...
class localityVC: UICollectionViewController,UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(localitycustomCell.self, forCellWithReuseIdentifier: cellidentifier)
    ...
    let searchBarView : TopSearchBarView = {
        ...
        view.searchbar.placeholder = "Search locality"
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "Top Locality"
...
class localitycustomCell: UICollectionViewCell {
    ...
    func setupviewbtn(){
        ...
        viewbtn.widthAnchor.constraint(equalToConstant: 150).isActive = true
    ...
    func setupsharebtn(){
        ...
        sharebtn.widthAnchor.constraint(equalToConstant: 150).isActive = true
