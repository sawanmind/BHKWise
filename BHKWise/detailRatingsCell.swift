...
class detailRatingsCell: UICollectionViewCell, UIScrollViewDelegate {
    ...
    func setupDetailedRatingsconatinerView(){
        scrollview.addSubview(DetailedRatingsconatinerView)
        DetailedRatingsconatinerView.centerXAnchor.constraint(equalTo: scrollview.centerXAnchor).isActive = true
        DetailedRatingsconatinerView.centerYAnchor.constraint(equalTo: scrollview.centerYAnchor).isActive = true
        DetailedRatingsconatinerView.widthAnchor.constraint(equalTo: scrollview.widthAnchor).isActive = true
        DetailedRatingsconatinerView.heightAnchor.constraint(equalTo: scrollview.heightAnchor).isActive = true
    ...
    let locatiobtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(housingDetailVC.handleDRlocation), for: .touchUpInside)
        return btn
    }()
    ...
    func setuplocatiobtn(){
        ...
        locatiobtn.centerXAnchor.constraint(equalTo: DetailedRatingsconatinerView.centerXAnchor).isActive = true
        locatiobtn.topAnchor.constraint(equalTo: DetailedRatingsconatinerView.topAnchor, constant: 55).isActive = true
        locatiobtn.widthAnchor.constraint(equalTo: DetailedRatingsconatinerView.widthAnchor, constant: -35).isActive = true
    ...
    let buildQualitybtn: UIButton = {
        ...
        btn.layer.cornerRadius = 23
        btn.layer.masksToBounds = true
        btn.addTarget(self, action: #selector(housingDetailVC.handleDRbuildquality), for: .touchUpInside)
        return btn
    }()
    
    func setupbuildQualitybtn(){
        addSubview(buildQualitybtn)
        buildQualitybtn.centerXAnchor.constraint(equalTo: DetailedRatingsconatinerView.centerXAnchor).isActive = true
        buildQualitybtn.topAnchor.constraint(equalTo: locatiobtn.bottomAnchor, constant: 20).isActive = true
        buildQualitybtn.widthAnchor.constraint(equalTo: DetailedRatingsconatinerView.widthAnchor, constant: -35).isActive = true
    ...
    let valueformoneybtn: UIButton = {
        ...
        btn.layer.cornerRadius = 23
        btn.layer.masksToBounds = true
        btn.addTarget(self, action: #selector(housingDetailVC.handleDRvalueformoney), for: .touchUpInside)
        return btn
    }()
    
    func setupvalueformoneybtn(){
        addSubview(valueformoneybtn)
        valueformoneybtn.centerXAnchor.constraint(equalTo: DetailedRatingsconatinerView.centerXAnchor).isActive = true
        valueformoneybtn.topAnchor.constraint(equalTo: buildQualitybtn.bottomAnchor, constant: 20).isActive = true
        valueformoneybtn.widthAnchor.constraint(equalTo: DetailedRatingsconatinerView.widthAnchor, constant: -35).isActive = true
    ...
    let interiorbtn: UIButton = {
        ...
        btn.layer.cornerRadius = 23
        btn.layer.masksToBounds = true
        btn.addTarget(self, action: #selector(housingDetailVC.hanldeDRinterior), for: .touchUpInside)
        return btn
    }()
    
    func setupinteriorbtn(){
        addSubview(interiorbtn)
        interiorbtn.centerXAnchor.constraint(equalTo: DetailedRatingsconatinerView.centerXAnchor).isActive = true
        interiorbtn.topAnchor.constraint(equalTo: valueformoneybtn.bottomAnchor, constant: 20).isActive = true
        interiorbtn.widthAnchor.constraint(equalTo: DetailedRatingsconatinerView.widthAnchor, constant: -35).isActive = true
    ...
    let smartbtn: UIButton = {
        ...
        btn.layer.cornerRadius = 23
        btn.layer.masksToBounds = true
        btn.addTarget(self, action: #selector(housingDetailVC.handleDRsmart), for: .touchUpInside)
        return btn
    }()
    
    func setupsmartbtn(){
        addSubview(smartbtn)
        smartbtn.centerXAnchor.constraint(equalTo: DetailedRatingsconatinerView.centerXAnchor).isActive = true
        smartbtn.topAnchor.constraint(equalTo: interiorbtn.bottomAnchor, constant: 20).isActive = true
        smartbtn.widthAnchor.constraint(equalTo: DetailedRatingsconatinerView.widthAnchor, constant: -35).isActive = true
    ...
    let qualityoflifebtn: UIButton = {
        ...
        btn.layer.cornerRadius = 23
        btn.layer.masksToBounds = true
        btn.addTarget(self, action: #selector(housingDetailVC.hanldeDRqualityoflife), for: .touchUpInside)
        return btn
    }()
    
    func setupqualityoflifebtn(){
        addSubview(qualityoflifebtn)
        qualityoflifebtn.centerXAnchor.constraint(equalTo: DetailedRatingsconatinerView.centerXAnchor).isActive = true
        qualityoflifebtn.topAnchor.constraint(equalTo: smartbtn.bottomAnchor, constant: 20).isActive = true
        qualityoflifebtn.widthAnchor.constraint(equalTo: DetailedRatingsconatinerView.widthAnchor, constant: -35).isActive = true
    ...
    override init(frame: CGRect){
        ...
        scrollview.contentSize = CGSize(width: DetailedRatingsconatinerView.bounds.width, height: 400)
        
        setupbgconatinerView()
        setupscrollview()
        setupDetailedRatingsconatinerView()
        setuplocatiobtn()
