...
class housingVC: UICollectionViewController,UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(housingcustomCell.self, forCellWithReuseIdentifier: cellidentifier)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellidentifier, for: indexPath) as! housingcustomCell
...
class housingcustomCell: UICollectionViewCell {
